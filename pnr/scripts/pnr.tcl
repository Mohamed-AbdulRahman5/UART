...
create_mw_lib   /home/ahesham/Desktop/Teaching/sources_2/pnr/${design} \
...
import_designs  /home/ahesham/Desktop/Teaching/sources_2/syn/output/${design}.v \
                -format verilog \
		-top ${design} \
		-cel ${design}
...
set_fp_rail_constraints  -set_ring -nets  {VDD VSS}  \
                         ...
                         -vertical_ring_layer {metal6 metal8 metal10 } \
			 -ring_spacing 0.8 \
			 -ring_width 5 \
			 -ring_offset 0.8 \
...
create_fp_virtual_pad -net VDD -point {34.3255 -1.0480}
create_fp_virtual_pad -net VDD -point {0.0000 110.7865}
create_fp_virtual_pad -net VDD -point {-1.1070 262.4825}
create_fp_virtual_pad -net VDD -point {0.0000 413.7505}
create_fp_virtual_pad -net VDD -point {0.0000 560.3960}
create_fp_virtual_pad -net VDD -point {113.1265 601.2475}
create_fp_virtual_pad -net VDD -point {265.0100 600.2000}
create_fp_virtual_pad -net VDD -point {410.6080 599.1525}
create_fp_virtual_pad -net VDD -point {562.4910 599.1525}
create_fp_virtual_pad -net VDD -point {601.2475 487.0735}
create_fp_virtual_pad -net VDD -point {600.2000 333.0950}
create_fp_virtual_pad -net VDD -point {602.2950 190.6395}
create_fp_virtual_pad -net VDD -point {603.3425 40.8510}
create_fp_virtual_pad -net VDD -point {486.0260 0.0000}
create_fp_virtual_pad -net VDD -point {332.0480 0.0000}
create_fp_virtual_pad -net VDD -point {187.4970 -2.0950}
create_fp_virtual_pad -net VSS -point {36.6615 601.2475}
create_fp_virtual_pad -net VSS -point {186.4495 600.2000}
create_fp_virtual_pad -net VSS -point {341.4750 599.1525}
create_fp_virtual_pad -net VSS -point {488.1210 600.2000}
create_fp_virtual_pad -net VSS -point {600.2000 561.4435}
create_fp_virtual_pad -net VSS -point {-2.0945 490.2155}
create_fp_virtual_pad -net VSS -point {601.2475 415.8455}
create_fp_virtual_pad -net VSS -point {1.0475 338.3325}
create_fp_virtual_pad -net VSS -point {603.3425 267.1045}
create_fp_virtual_pad -net VSS -point {600.2000 114.1740}
create_fp_virtual_pad -net VSS -point {564.5860 -1.0475}
create_fp_virtual_pad -net VSS -point {411.6555 1.0475}
create_fp_virtual_pad -net VSS -point {261.8675 -1.0475}
create_fp_virtual_pad -net VSS -point {114.1740 0.0000}
create_fp_virtual_pad -net VSS -point {1.0475 39.8035}
create_fp_virtual_pad -net VSS -point {-1.0475 189.5920}
...
write_stream  \
                  -format gds\
		  -cells $design\
		  /home/ahesham/Desktop/Teaching/sources_2/pnr/output/${design}.gds
...
write_verilog -pg -no_physical_only_cells /home/ahesham/Desktop/Teaching/sources_2/pnr/output/${design}_icc.v
write_verilog -no_physical_only_cells /home/ahesham/Desktop/Teaching/sources_2/pnr/output/${design}_icc_nopg.v

extract_rc
write_parasitics -output {/home/ahesham/Desktop/Teaching/sources_2/pnr/output/${design}.spef}
